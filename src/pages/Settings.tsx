...
const Settings = () => {
  ...
  // Fixed tab sections for mobile and desktop
  const tabSections = [
      ...
      <div className="space-y-8">
        ...
        <div className="flex flex-col space-y-8 lg:flex-row lg:space-x-12 lg:space-y-0">
          <div className="lg:w-1/4">
            {/* Desktop navigation - using normal styling instead of vertical Tabs */}
            <div className="hidden lg:block space-y-1">
              {tabSections.map((tab) => (
                <button
                  key={tab.value}
                  onClick={() => setActiveTab(tab.value)}
                  className={`flex w-full items-center justify-start border-b px-3 py-2 text-left first:rounded-t-md last:rounded-b-md ${
                    activeTab === tab.value 
